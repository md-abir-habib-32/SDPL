...
#Step 3 (Create a Factory to generate object of concrete class basedon given information.)
class ShapeFactory:
...
#Step 4 (Use the Factory to get object of concrete class by passing aninformation such as type.)
def shapes_client():
